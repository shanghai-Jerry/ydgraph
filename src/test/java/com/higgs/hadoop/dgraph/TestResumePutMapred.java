package com.higgs.hadoop.dgraph;
...
public class TestResumePutMapred extends Configured implements Tool {
  ...
  public static class Map extends Mapper<LongWritable, Text, NullWritable, Put> {
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
      ...
      // dClient.InitDict("/Users/devops/workspace/com.higgs.hbase-TestDemo/src/StartMain/resources/school_dict
      // .txt");
  ...
  public void configJob(Job job, String input, String tableName) throws Exception {
    ...
    job.setJobName("hadoop.com.higgs.dgraph put -" + input.substring(input.lastIndexOf("/") + 1));
  ...
  public static void main(String[] args) throws Exception {
    args = new String[]{"/Users/devops/workspace/com.higgs.hbase-TestDemo/src/StartMain/resources/part-m-00371" +
        "", "/Users/devops/workspace/com.higgs.hbase-TestDemo/src/StartMain/resources", "idmg:resume_test",};
